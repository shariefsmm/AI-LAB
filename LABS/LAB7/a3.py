...
class Agent:
	...
	def BFS(self):
		...
		heapq.heappush(self.h,(0+self.CYC(x,y,s.budget),(s.source,-1,0,s.budget,-1)))
			...
			for i in range(0,s.n):
				...
				if n!=-1.0:
					...
					if n>3:
						...
						cost=Tbus*s.rate
						if b-cost>=0:
							heapq.heappush(self.h,(g+Tbus+self.CYC(x,y,b),(i,count-1,g+Tbus,b-cost,1)))
							t=self.BUS(x,y,b)
							if t!=-1:
								heapq.heappush(self.h,(g+Tbus+t,(i,count-1,g+Tbus,b-cost,1)))
						
					Tcycl=n/s.Cycle
					heapq.heappush(self.h,(g+Tcycl+self.CYC(x,y,b),(i,count-1,g+Tcycl,b,0)))
					t=self.BUS(x,y,b)
